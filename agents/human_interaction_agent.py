...
class HumanInteractionAgent:
    def __init__(self):
        self.model = YOLO(os.path.abspath(os.path.join('models', 'human_detection_yolo', 'yolov8s.pt')))
        self.boxes = None
    ...
    def should_move(self):
        ...
        self.time_2 = time.time()
        if (not moved and (self.time_2 - self.time_1 > 3600 * 3) and # time threshold (seconds)
